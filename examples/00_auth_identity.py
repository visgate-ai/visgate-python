"""
Step 02: Verify API auth identity via /auth/me. Tested against live API.
"""
...
def main() -> None:
    with _tee_stdout():
        with _create_client() as client:
            data = client._request("GET", "/auth/me")
            org = data.get("organization", {})
            print("auth_ok=true")
            print(f"organization_id={org.get('id')}")
            print(f"organization_name={org.get('name')}")
